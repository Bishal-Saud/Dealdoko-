...
const translations = {
  ...
  ne: {
    ...
    footerText: "Aba padhna sanga-sanga sikhaune ra earn garne duita kaam ekai sath  गर्नुहोस्। TolPath मा register गरेर locally कमाउनुहोस्। 🚀",
    cta: "अहिले नै Register गर्नुहोस्"
  }
};

function BecomeATeacherAds() {
