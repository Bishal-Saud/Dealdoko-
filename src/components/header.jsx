...
function Header() {
  ...
  <link rel="canonical" href="https://www.tolpath.com/" />
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t px-6 py-2.5 flex justify-between items-center z-40 shadow-md">
        <Link
          to="/"
          className="flex flex-col items-center gap-1 text-blue-600 text-[10px] font-semibold"
        >
          <Home size={20} />
        ...
        <button
          onClick={handleOpenChat}
          className="flex flex-col items-center gap-1 text-gray-400 text-[10px] relative"
        >
          <MessageSquare size={20} />

          {hasNewMessage && (
            <span className="absolute top-0 right-1 flex h-2 w-2 rounded-full bg-red-500 ring-2 ring-white" />
          )}
        ...
        <Link
          to={isVerifiedSeller ? "/seller-dashboard" : "/role"}
          className="flex flex-col items-center gap-1 text-gray-400 hover:text-blue-600 text-[10px] transition"
        >
          <PlusCircle size={20} />
        ...
        {currentUser ? (
          <button
            onClick={() => setIsSidebarOpen(true)}
            className="flex flex-col items-center gap-1 text-gray-400 text-[10px]"
          >
            <img
              src={userAvatar}
              alt="Profile"
        ...
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="relative w-full max-w-xs md:max-w-sm h-full bg-white shadow-2xl flex flex-col z-10">
            ...
            <div className="p-6 border-b flex flex-col items-center text-center bg-gradient-to-b from-gray-50 to-white">
              ...
              <p className="text-xs text-gray-400 font-medium truncate max-w-full">
                {currentUser?.email}
              </p>
            </div>
            ...
            <div className="flex-1 overflow-y-auto py-4 px-3 space-y-1">
              <Link
                to="/profile"
                onClick={() => setIsSidebarOpen(false)}
                className="w-full flex items-center justify-between p-3 text-gray-700 hover:bg-blue-50/50 hover:text-blue-600 rounded-xl font-semibold transition group"
              >
              ...
              >
                <div className="flex items-center gap-3">
                  <Store
                    size={18}
                    className={
                      isVerifiedSeller ? "text-amber-500" : "text-gray-400"
                    }
                  />
              ...
              <Link
                to="/verify"
                onClick={() => setIsSidebarOpen(false)}
                className="w-full flex items-center justify-between p-3 text-gray-700 hover:bg-amber-50/50 hover:text-amber-600 rounded-xl font-semibold transition group"
              >
                <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-between p-3 text-gray-700 hover:bg-blue-50/50 hover:text-blue-600 rounded-xl font-semibold transition group text-left"
              >
                <div className="flex items-center gap-3">
            ...
            <div className="p-4 border-t bg-gray-50">
              <button
                ...
                className="w-full py-3 bg-red-50 hover:bg-red-100 text-red-600 font-bold rounded-xl flex items-center justify-center gap-2 transition border border-red-200/40"
              >
                <LogOut size={18} />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-blue-600/50 backdrop-blur-xs">
          <div className="relative w-full max-w-sm bg-white rounded-3xl shadow-2xl p-6 md:p-8 text-center">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Sign in or create your account instantly using your Google
              profile.
            </p>
