      ...
      <div className="max-w-7xl mx-auto px-8 pt-16 pb-8">
        ...
        <div className="grid grid-cols-4 gap-8 mb-12">
          ...
          <nav className="space-y-4" aria-label="Trust and Legal">
            ...
            <ul className="space-y-2.5 text-sm font-semibold">
              <li><Link to="/verify" className="text-slate-400 hover:text-amber-400 transition flex items-center gap-2">
                <ShieldCheck size={16} className="text-amber-500" /> KYC Verified Tutors
              </Link></li>
              <li><Link to="/terms-and-policy" className="text-slate-400 hover:text-white transition">Terms and Policy</Link></li>
              <li><Link to="/aboutus" className="text-slate-400 hover:text-white transition">About Tol Path</Link></li>
            </ul>
          </nav>

          {/* Contact & National Presence */}
          <address className="space-y-4 not-italic">
            <h4 className="text-sm font-bold uppercase tracking-wider text-slate-400">Connect</h4>
            <div className="space-y-2 text-sm font-medium text-slate-400">
              <a href="mailto:tolpath.official@gmail.com" className="flex items-center gap-2 hover:text-white transition">
                <Mail size={16} className="text-blue-500" /> tolpath.official@gmail.com
              </a>
              <div className="flex items-center gap-2">
                <MapPin size={16} className="text-blue-500" /> <span>HQ: Kanchanpur, Nepal</span>
              </div>
            </div>
          </address>
        </div>
        ...
        <div className="border-t border-slate-900 pt-8 mt-4 flex justify-between text-slate-500 text-xs">
          <p>&copy; {new Date().getFullYear()} Tol Path. Providing home tuition services across Nepal.</p>
